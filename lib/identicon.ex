defmodule Identicon do
  @moduledoc """
    Module containing functions associated with creating an identicon.
  """

  @doc """
    Given a string input, creates and saves an identicon image. Check for a .png
    file in project directory after creation.

  ## Examples

      iex> Identicon.generate('zeus-')
      :ok
  ...
  def draw_image(%Identicon.Image{color: color, pixel_map: pixel_map}) do
    ...
    Enum.each(pixel_map, fn({top_left, bottom_right}) ->
      # Oddity in egd in which given image is modified
  ...
  def filter_odd_squares(%Identicon.Image{grid: grid} = image_struct) do
    ...
    %Identicon.Image{image_struct | grid: even_grid}
  end
